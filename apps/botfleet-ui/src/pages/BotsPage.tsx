    ...
    <section className="p-10 space-y-8">
      <header className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-4xl font-semibold text-white mt-1">Filtered Overview</h1>
        ...
        <div className="flex gap-3">
          <button
            type="button"
            className="h-11 px-4 rounded-xl border border-slate-700 text-slate-200 text-sm flex items-center gap-2"
            onClick={loadBots}
          >
          ...
          <button
            ...
            className="h-11 px-5 rounded-xl bg-indigo-500 text-white text-sm font-semibold flex items-center gap-2"
          >
      ...
      {isLoading ? (
        <div className="text-slate-500">Loading bots…</div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          {!filteredBots.length && (
            <div className="col-span-full text-center text-slate-500 py-16 border border-dashed border-slate-800 rounded-2xl">
