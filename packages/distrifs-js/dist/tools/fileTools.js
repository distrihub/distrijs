...
export const createFilesystemTools = (projectId, options = {}) => {
    ...
    const tools = [
        ...
        },
        {
            ...
            handler: async (input) => filesystem.getFileInfo(input.path),
        },
        {
        ...
        },
        {
            ...
            handler: async (input) => filesystem.tree(input.path),
        },
        {
            name: 'list_artifacts',
        ...
        },
        {
            ...
            handler: async (input) => filesystem.readArtifact(input.filename, input.start_line, input.end_line),
        },
        {
...
function sliceFile(result, start, end) {
    if (!start && !end) {
        return result;
    }
