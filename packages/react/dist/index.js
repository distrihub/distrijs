...
import { useState as useState3, useCallback as useCallback3, useRef as useRef5, useEffect as useEffect6 } from "react";
...
var ChatInput = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: `relative flex min-h-14 w-full items-end ${className}`, children: /* @__PURE__ */ jsx("div", { className: "relative flex w-full flex-auto flex-col", children: /* @__PURE__ */ jsxs("div", { className: "relative mx-5 flex min-h-14 flex-auto rounded-lg border border-input bg-input items-start h-full", children: [
    /* @__PURE__ */ jsx(
      "textarea",
      {
        ref: textareaRef,
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute right-2 bottom-0 flex items-center h-full", children: /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: isStreaming ? /* @__PURE__ */ jsx(Square, { className: "h-5 w-5" }) : /* @__PURE__ */ jsx(Send, { className: "h-5 w-5" })
      }
    ) })
  ] }) }) });
};
...
// src/useChat.ts
import { useCallback as useCallback2, useEffect as useEffect5, useRef as useRef4 } from "react";
...
var ApprovalToolCall = ({
  ...
  if (status === "completed") {
    ...
    return /* @__PURE__ */ jsxs2("div", { className: "border rounded-lg p-4 bg-muted/50", children: [
      /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2 mb-2", children: [
        result.approved ? /* @__PURE__ */ jsx3(CheckCircle, { className: "h-4 w-4 text-green-600" }) : /* @__PURE__ */ jsx3(XCircle, { className: "h-4 w-4 text-red-600" }),
        /* @__PURE__ */ jsxs2("span", { className: "font-medium", children: [
          "Approval ",
          result.approved ? "Granted" : "Denied"
        ] })
      ] }),
      /* @__PURE__ */ jsx3("p", { className: "text-sm text-muted-foreground", children: reason })
    ] });
  }
  return /* @__PURE__ */ jsxs2("div", { className: "border rounded-lg p-4 bg-background", children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2 mb-3", children: [
      /* @__PURE__ */ jsx3(AlertTriangle, { className: "h-4 w-4 text-amber-500" }),
      /* @__PURE__ */ jsx3("span", { className: "font-medium", children: "Approval Required" })
    ] }),
    /* @__PURE__ */ jsx3("p", { className: "text-sm mb-4", children: reason }),
    toolCallsToApprove.length > 0 && /* @__PURE__ */ jsxs2("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsx3("p", { className: "text-xs text-muted-foreground mb-2", children: "Tool calls requiring approval:" }),
      /* @__PURE__ */ jsx3("div", { className: "space-y-1", children: toolCallsToApprove.map((tc, index) => /* @__PURE__ */ jsx3("div", { className: "text-xs bg-muted p-2 rounded", children: /* @__PURE__ */ jsx3("span", { className: "font-mono", children: tc.tool_name }) }, index)) })
    ] }),
...
var defaultTools = [
  {
    ...
    component: (props) => {
      return /* @__PURE__ */ jsx5(ToastToolCall, { ...props });
    }
  }
  // {
...
function useChatMessages({
  ...
  const onMessageProcessRef = useRef3(onMessageProcess);
  useEffect4(() => {
...
function useChat({
  ...
  const getMetadataRef = useRef4(getMetadata);
  useEffect5(() => {
  ...
  const addMessageToHookRef = useRef4(addMessageToHook);
  useEffect5(() => {
  ...
  const addMessageRef = useRef4(addMessage);
  useEffect5(() => {
  ...
  const agentIdRef = useRef4(void 0);
  useEffect5(() => {
  ...
  const handleExternalToolResponses = useCallback2(async () => {
...
var Avatar = React5.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx6(
...
function renderTextContent(content) {
  ...
  if (hasMarkdown || hasCode || hasLinks || hasImages) {
    return React6.createElement("pre", { className: "whitespace-pre-wrap text-sm" }, text);
  }
  const paragraphs = text.split("\n").filter((p) => p.trim());
  if (paragraphs.length === 1) {
    return React6.createElement("p", { className: "text-sm leading-relaxed" }, text);
  } else {
    return React6.createElement(
      "div",
      { className: "space-y-2" },
      paragraphs.map(
        (paragraph, index) => React6.createElement("p", {
          key: index,
...
function ToolResultRenderer({
  ...
  return /* @__PURE__ */ jsxs8(Card, { className: `mb-4 ${className}`, children: [
    /* @__PURE__ */ jsx15(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxs8("div", { className: "flex items-center justify-between", children: [
    ...
    /* @__PURE__ */ jsxs8(CardContent, { className: "pt-0 space-y-3", children: [
      ...
      onSendResponse && success && /* @__PURE__ */ jsx15("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxs8(
        Button,
        {
          size: "sm",
...
import { Brain as Brain2, Sparkles } from "lucide-react";
...
var ThinkingRenderer = ({
  ...
  const getIconAndText = () => {
    switch (indicator) {
      ...
      case "generating":
        return {
          icon: /* @__PURE__ */ jsx18("div", { className: "text-sm font-medium text-foreground mb-3 flex items-center gap-2", children: /* @__PURE__ */ jsxs11("div", { className: "flex items-center gap-1 text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsx18("div", { className: "w-1 h-1 bg-muted-foreground rounded-full animate-pulse" }),
            /* @__PURE__ */ jsx18("div", { className: "w-1 h-1 bg-muted-foreground rounded-full animate-pulse delay-75" }),
            /* @__PURE__ */ jsx18("div", { className: "w-1 h-1 bg-muted-foreground rounded-full animate-pulse delay-150" })
          ] }) }),
          text: null
        };
      case "planning":
...
function Chat({
  ...
  const handleSendMessage = useCallback3(async (content) => {
    if (!content.trim()) return;
    setInput("");
    await sendMessage(content);
  }, [sendMessage]);
  const handleStopStreaming = useCallback3(() => {
    stopStreaming();
  }, [stopStreaming]);
  const toggleToolExpansion = useCallback3((toolId) => {
  ...
  return /* @__PURE__ */ jsxs12("div", { className: `flex flex-col h-full ${getThemeClasses()}`, children: [
    /* @__PURE__ */ jsx19("div", { className: "flex-1 overflow-y-auto bg-background text-foreground", children: /* @__PURE__ */ jsxs12("div", { className: "max-w-4xl mx-auto px-4 py-8", children: [
      renderMessages(),
    ...
    error && /* @__PURE__ */ jsx19("div", { className: "p-4 bg-destructive/10 border-l-4 border-destructive", children: /* @__PURE__ */ jsxs12("div", { className: "text-destructive text-xs", children: [
...
import { createContext as createContext2, useContext as useContext2, useEffect as useEffect8, useState as useState5 } from "react";
import { DistriClient as DistriClient2 } from "@distri/core";

// src/components/ThemeProvider.tsx
import { createContext, useContext, useEffect as useEffect7, useState as useState4 } from "react";
...
function ThemeToggle() {
  ...
  return /* @__PURE__ */ jsx22("div", { className: "relative", ref: dropdownRef, children: /* @__PURE__ */ jsxs13(
    "button",
    {
...
var AgentList = ({ agents, onRefresh, onStartChat }) => {
  ...
  return /* @__PURE__ */ jsxs14("div", { className: "", children: [
    ...
    /* @__PURE__ */ jsx23("div", { className: "p-6", children: agents.length === 0 ? /* @__PURE__ */ jsxs14("div", { className: "text-center py-12", children: [
      /* @__PURE__ */ jsx23(Bot, { className: "h-16 w-16 text-muted-foreground mx-auto mb-4" }),
    ...
    ] }) : /* @__PURE__ */ jsx23("div", { className: "grid gap-6 md:grid-cols-2 lg:grid-cols-3", children: agents.map((agent) => /* @__PURE__ */ jsxs14(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx23("div", { className: "flex items-start justify-between mb-4", children: /* @__PURE__ */ jsxs14("div", { className: "flex items-center space-x-3", children: [
            /* @__PURE__ */ jsx23("div", { className: "w-12 h-12 bg-primary rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx23(Bot, { className: "h-6 w-6 text-primary-foreground" }) }),
          ...
          /* @__PURE__ */ jsxs14("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsx23("div", { className: "flex items-center space-x-2", children: /* @__PURE__ */ jsxs14(
              "button",
              {
...
var SelectContent = React12.forwardRef(({ className, children, position = "popper", ...props }, ref) => /* @__PURE__ */ jsx24(SelectPrimitive.Portal, { children: /* @__PURE__ */ jsxs15(
...
var AgentSelect = ({
  ...
  return /* @__PURE__ */ jsxs16(Select, { value: selectedAgentId, onValueChange: onAgentSelect, disabled, children: [
    /* @__PURE__ */ jsx25(SelectTrigger, { className: `w-full ${className} ${disabled ? "opacity-50 cursor-not-allowed" : ""}`, children: /* @__PURE__ */ jsxs16("div", { className: "flex items-center space-x-2", children: [
      /* @__PURE__ */ jsx25(Bot2, { className: "h-4 w-4" }),
      /* @__PURE__ */ jsx25(SelectValue, { placeholder, children: selectedAgent?.name || placeholder })
    ] }) }),
    /* @__PURE__ */ jsx25(SelectContent, { children: agents.map((agent) => /* @__PURE__ */ jsx25(SelectItem, { value: agent.id, children: /* @__PURE__ */ jsxs16("div", { className: "flex items-center space-x-2", children: [
      /* @__PURE__ */ jsx25(Bot2, { className: "h-4 w-4" }),
...
import { useState as useState6, useEffect as useEffect9, useCallback as useCallback4 } from "react";
function useAgentDefinitions() {
  ...
  const getAgent = useCallback4(async (agentId) => {
    if (!client) {
...
var AgentsPage = ({ onStartChat }) => {
  ...
  if (loading) {
    return /* @__PURE__ */ jsx26("div", { className: "h-full bg-background flex items-center justify-center", children: /* @__PURE__ */ jsxs17("div", { className: "flex items-center space-x-2", children: [
  ...
  return /* @__PURE__ */ jsx26("div", { className: "h-full bg-background overflow-auto", children: /* @__PURE__ */ jsxs17("div", { className: "container mx-auto p-6", children: [
...
var ExecutionSteps = ({ messages, className = "" }) => {
  ...
  return /* @__PURE__ */ jsx27("div", { className: `space-y-3 ${className}`, children: steps.map((step) => /* @__PURE__ */ jsxs18(Card, { className: "border-l-4 border-l-blue-200", children: [
    /* @__PURE__ */ jsx27(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxs18("div", { className: "flex items-center justify-between", children: [
...
var TaskExecutionRenderer = ({
  ...
  const getStepIcon = (step) => {
    switch (step.status) {
      ...
      case "running":
        return /* @__PURE__ */ jsx28(Loader23, { className: "w-4 h-4 text-blue-600 animate-spin" });
      default:
  ...
  return /* @__PURE__ */ jsx28("div", { className: `space-y-3 ${className}`, children: steps.map((step) => /* @__PURE__ */ jsxs19(Card, { className: "border-l-4 border-l-blue-200", children: [
    /* @__PURE__ */ jsx28(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxs19("div", { className: "flex items-center justify-between", children: [
...
// src/useAgent.ts
import React15, { useState as useState7, useCallback as useCallback5, useRef as useRef6 } from "react";
import {
  Agent as Agent4
} from "@distri/core";
function useAgent({
  ...
  const currentAgentIdRef = useRef6(null);
  const initializeAgent = useCallback5(async () => {
    ...
    try {
      ...
      const newAgent = await Agent4.create(agentIdOrDef, client);
...
// src/useThreads.ts
import { useState as useState8, useEffect as useEffect10, useCallback as useCallback6 } from "react";
function useThreads() {
  const { client, error: clientError, isLoading: clientLoading } = useDistri();
  const [threads, setThreads] = useState8([]);
  const [loading, setLoading] = useState8(true);
  const [error, setError] = useState8(null);
  const fetchThreads = useCallback6(async () => {
    if (!client) {
  ...
  const fetchThread = useCallback6(async (threadId) => {
    if (!client) {
      throw new Error("Client not available");
    }
    try {
  ...
  const deleteThread = useCallback6(async (threadId) => {
    if (!client) {
      throw new Error("Client not available");
    }
    try {
  ...
  const updateThread = useCallback6(async (threadId, localId) => {
    if (!client) {
      return;
    }
    try {
...
var DropdownMenuSubTrigger = React24.forwardRef(({ className, inset, children, ...props }, ref) => /* @__PURE__ */ jsxs24(
  DropdownMenuPrimitive.SubTrigger,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx39(ChevronRight2, { className: "ml-auto" })
    ]
  }
));
DropdownMenuSubTrigger.displayName = DropdownMenuPrimitive.SubTrigger.displayName;
var DropdownMenuSubContent = React24.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx39(
...
var DropdownMenuContent = React24.forwardRef(({ className, sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsx39(DropdownMenuPrimitive.Portal, { children: /* @__PURE__ */ jsx39(
...
var DropdownMenuItem = React24.forwardRef(({ className, inset, ...props }, ref) => /* @__PURE__ */ jsx39(
...
var DropdownMenuCheckboxItem = React24.forwardRef(({ className, children, checked, ...props }, ref) => /* @__PURE__ */ jsxs24(
  DropdownMenuPrimitive.CheckboxItem,
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx39("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ jsx39(DropdownMenuPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx39(Check2, { className: "h-4 w-4" }) }) }),
      children
    ]
  }
));
DropdownMenuCheckboxItem.displayName = DropdownMenuPrimitive.CheckboxItem.displayName;
var DropdownMenuRadioItem = React24.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs24(
...
var DropdownMenuLabel = React24.forwardRef(({ className, inset, ...props }, ref) => /* @__PURE__ */ jsx39(
...
var DropdownMenuSeparator = React24.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx39(
...
export {
  AgentList_default as AgentList,
  AgentSelect,
  AgentsPage_default as AgentsPage,
  ApprovalToolCall,
  ArtifactRenderer,
  AssistantMessageRenderer,
  Badge,
