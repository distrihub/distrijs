...
With those variables in place the demo wraps the workspace in `FileWorkspaceWithChat`, wiring the generated filesystem tools (and the embedded script runner UI tool) into the Distri agent workflow.
