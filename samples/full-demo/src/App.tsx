...
import { MessageSquare, Settings, Activity, Loader2, Bot, Code, Wrench } from 'lucide-react';
...
function AppContent() {
  ...
  const [activeTab, setActiveTab] = useState<'chat' | 'agents' | 'tasks' | 'tools' | 'demo'>('chat');
