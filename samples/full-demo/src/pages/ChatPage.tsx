import { DistriAgent, DistriThread, useThreads, Chat } from "@distri/react";
  ...
  return (
    <div className="flex-1 flex items-center justify-center">
      <div className="text-center">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-gray-300 mb-2 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
